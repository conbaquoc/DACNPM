...
import { Button, Table, Icon, Popconfirm, message, Form, Input, Modal } from "antd";
      ...
      <div className="all">
        ...
        <Table dataSource={this.state.persons} bordered>
          <Column 
           ...
           />
          <Column title="Name" dataIndex="fullName" key="fullName" {...this.getColumnSearchProps('fullName')} />
          <Column title="SDT" dataIndex="phoneNumber" key="phoneNumber" {...this.getColumnSearchProps('phoneNumber')}/>
